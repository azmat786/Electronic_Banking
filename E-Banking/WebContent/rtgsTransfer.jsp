...
<title>Rtgs Transfer</title>
	...
	function validate(x){
		 if(x.amount.value < 200000 || x.amount.value > 1000000){
			 alert("amount can not be a less than 200000Rs and greater than 1000000Rs");
			 x.amount.focus();
			 return false;
		 }
		return true;	 
...
<body onload="check1()">
	<div>
		<center><h3>Rtgs Transfer</h3></center>
